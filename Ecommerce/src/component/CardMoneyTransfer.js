...
cards.push(card);
  ...
  const handleSelectOptionChange = (e) => {
    const selectedValue = e.target.value;
    setFormData((prevFormData) => ({ ...prevFormData, paymentType: selectedValue }));
  };
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <label htmlFor="FromAccount">
        CardNumber:
        <input type="text" name="cardNumber" value={formData.cardNumber} onChange={handleChange} required/><br/><br/>
      </label> 
      {/* <label htmlFor="ToAccount">
        ToAccount:
        <input type="text" name="toAccount" value={formData.toAccount} onChange={handleChange} required/><br/><br/>
      </label> */}
...
<option value="">PaymentType</option>
  ...
  <option value="MER">Merchendise</option>
